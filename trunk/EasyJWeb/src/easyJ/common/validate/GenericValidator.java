...
public class GenericValidator implements Serializable {
     ...
     * with <code>java.text.DateFormat</code>. The setLenient method is set
    ...
    /**
     * <p>
     * Checks if the class is a set type class.
     * </p>
     * 
     * @param value
     *                The value validation is being performed on.
    ...
    public static boolean isSetType(Class type) {
        ...
        for (int i = 0; i < types.length; i++)
            if (types[i].equals(ArrayList.class) || types[i].equals(List.class))
                return true;
        for (int i = 0; i < interfaceTypes.length; i++)
            if (interfaceTypes[i].equals(ArrayList.class)
                    || interfaceTypes[i].equals(List.class))
                return true;
        return false;
     ...
     * @return true if the value is in the specified range.
     */
    public static boolean isInRange(String value, String min, String max,
            Class type) {
        if (type.equals(Integer.class))
            return isInRange(Integer.parseInt(value), Integer.parseInt(min),
                    Integer.parseInt(max));
        if (type.equals(Double.class))
            return isInRange(Double.parseDouble(value),
                    Double.parseDouble(min), Double.parseDouble(max));
        if (type.equals(Long.class))
            return isInRange(Long.parseLong(value), Long.parseLong(min), Long
                    .parseLong(max));
        if (type.equals(Float.class))
            return isInRange(Float.parseFloat(value), Float.parseFloat(min),
     ...
     * Checks if the value's length is less than or equal to the max.
     * </p>
     * 这里用maxLen这个方法名是因为在客户端maxLength用作方法名是有问题的。
     * 
     * @param value
     *                The value validation is being performed on.
     * @param max
     ...
     * @return true if the value's length is less than the specified maximum.
     */
    public static boolean maxLen(String value, String max) {
        if (value == null)
            return true;
     ...
     * @return true if the value's length is more than the specified minimum.
     */
    public static boolean minLen(String value, String min) {
        if (value == null)
            return true;
    ...
    /**
     * Calculate an adjustment amount for line endings. See Bug 37962 for the
     ...
     *                The value validation is being performed on.
     * @param min
     *                The maximum value in string format.
     * @param type
     *                The class of the value and min
     * @return true if the value is &lt;= the specified min.
     */
    public static boolean minValue(String value, String min) {
        if (isBlankOrNull(value))
            return true;
     ...
     *                The maximum value in string format.
     * @param type
     *                The class of the value and max
     * @return true if the value is &lt;= the specified maximum.
     */
    public static boolean maxValue(String value, String max) {
        /* 如果数字为空，说明用户没有填数据，这是允许的 */
        if (isBlankOrNull(value))
            return true;
