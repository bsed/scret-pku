...
<%@ page
	import="easyJ.common.*,easyJ.http.Globals,java.util.*,easyJ.system.service.*,easyJ.system.data.*"%>
...
<table class="border" width="100%">
	<tr>
		<td>
			...
			<easyJ:FunctionTag pageName="CompositeDataEdit.jsp"
				position="<%=Globals.FUNCTION_EDIT%>" />
		</td>
	</tr>
</table>
