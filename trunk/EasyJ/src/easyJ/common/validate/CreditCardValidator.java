 ...
 * should pass validation by configuring the validation options. For example,<br/><code>CreditCardValidator ccv = new CreditCardValidator(CreditCardValidator.AMEX + CreditCardValidator.VISA);</code>
 ...
 * </p>
 * For a similar implementation in Perl, reference Sean M. Burke's <a
 * href="http://www.speech.cs.cmu.edu/~sburke/pub/luhn_lib.html">script</a>.
 * More information is also available <a
 * href="http://www.merriampark.com/anatomycc.htm">here</a>.
 * 
...
public class CreditCardValidator {
     ...
     * 
     * @param options
     *                Pass in CreditCardValidator.VISA +
     *                CreditCardValidator.AMEX to specify that those are the
