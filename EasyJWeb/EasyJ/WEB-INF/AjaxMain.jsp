...
/*这个方法用来显示场景角色数据关系图的，因为需要在功能列表中使用此方法，所以放到这里*/
  ...
  function getSelectedScenarios() {
    ...
    var fileName=Ajax.submit(
    "cn.edu.pku.dr.requirement.elicitation.action.ScenarioAction.do?ACTION=showRelationDiagram&easyJ.http.Globals.CLASS_NAME=cn.edu.pku.dr.requirement.elicitation.data.Scenario&ajax=true",
    null,
    data);
  ...
  **/
  function showFeatureModel(){
  	var data ={};  	
  	var fileName = Ajax.submit(
  	"cn.edu.pku.dr.requirement.elicitation.action.ProjectAction.do?ACTION=showFeatureModel&easyJ.http.Globals.CLASS_NAME=cn.edu.pku.dr.requirement.elicitation.data.Project&ajax=true",
  	null,
  	data);
  	document.getElementById("featureModel").style.display = "block";
  	document.getElementById("featureModel").innerHTML = 
  	"<div align=center><applet code=\"applet.MainApplet\" archive =\"jars/FMTool_Web.jar,"+ 
  			"jars/swing-layout.jar, jars/swing-worker.jar, jars/swingx-0.9.4.jar,	 jars/swingx.jar, 		 jars/forms-1.2.1.jar,jars/DockingUI.jar,jars/jdom.jar, 		 jars/freehep-base.jar, 	 jars/freehep-graphics2d.jar, 		 jars/freehep-graphicsio-cgm.jar,    		 jars/freehep-graphicsio-emf.jar,    		 jars/freehep-graphicsio-gif.jar,    		 jars/freehep-graphicsio-java.jar,    		 jars/freehep-graphicsio-pdf.jar,    		 jars/freehep-graphicsio-ppm.jar,    		 jars/freehep-graphicsio-ps.jar,    		 jars/freehep-graphicsio-svg.jar,"+
    		 ...
    		 "jars/batik-util.jar,"+
    		 "jars/batik-xml.jar\"  width = 1000 height = 1000></applet></div> "; 
  }
