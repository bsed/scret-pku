...
public class Utils {
	...
	public static String SQL_MAP_CONFIG_PATH = "sqlMapConfigEJ.xml";
	public static String SQL_MAP_CONFIG_PATH_FM = "fmSqlMapConfig.xml";
	...
	private static SqlMapClient fmSqlMapClient = null;
	private static SqlMapClient localClient = null;
	
	
	public static SqlMapClient getFeatureModelMapClient(){
		if(fmSqlMapClient != null) return fmSqlMapClient;		
		try {
	        Reader reader = Resources.getResourceAsReader(SQL_MAP_CONFIG_PATH_FM);
	        fmSqlMapClient = SqlMapClientBuilder.buildSqlMapClient(reader);	        
	        
	    } catch (Exception e) {
	        e.printStackTrace();
	    }
	    return fmSqlMapClient;
	}
