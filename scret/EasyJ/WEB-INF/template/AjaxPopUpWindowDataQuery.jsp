...
%>
<p align="right"><img align="right" onclick="PopUpWindow.hide()" src="image/assoc_delete.gif" /></p>
<br>
<form name="selectDataForm" method="post" action="" id="selectDataForm" type="enter2tab">
  ...
  <easyJ:FunctionTag pageName="PopUpWindowDataQuery.jsp" position="<%=Globals.FUNCTION_QUERY%>"/>
  </td></tr></table>
  ...
  <input type="hidden" id="<%=Globals.RETURN_PATH%>" name="<%=Globals.RETURN_PATH%>" value="/WEB-INF/template/AjaxPopUpWindowDataQuery.jsp"/>
